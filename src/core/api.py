...
def get(*args: str, **kwargs: Any) -> Union[List[Any], Dict[str, Any]]:
...
def post(*args: str, **kwargs: Any) -> Union[List[Any], Dict[str, Any]]:
    url = __create_api_url(*args)
...
def put(*args: str, **kwargs: Any) -> Union[List[Any], Dict[str, Any]]:
    url = __create_api_url(*args)
...
def delete(*args: str, **kwargs: Any) -> Union[List[Any], Dict[str, Any]]:
    url = __create_api_url(*args)
